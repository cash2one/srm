...
# Django settings for SiteRankMonitor project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dsyhan$site_rank',  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'zda=0f3lb*7zk1v5+35(mu)0c@ys%76lubu_+yaq@^%cv*c7xk'
